...
| **Avg Inference Latency** | **10111.6 ms** (10.11 s) | **6646.6 ms** (6.65 s) | -3465.0 ms (-34.3%) | 38.5% Latency Reduction |
| **Generation Throughput** | **47.7 tok/s** | **67.9 tok/s** | +20.2 tok/s | Higher Generation Speed |
...
| **CTX-02** | *"I'm heading to sleep"* | **PASS** | **PASS** | `['living_room_light.turn_off', 'front_door_lock.lock']` | `['living_room_light.turn_off', 'kitchen_light.turn_off', 'bedroom_light.turn_off', 'front_door_lock.lock']` |
...
| **PC-04** | *"Lock my computer"* | **PASS** | **PASS** | `['lock_pc.lock']` | `['system_control.lock_pc']` |
...
3. **Inference Latency & Generation Speed:**
   - Baseline Latency: **10.11 s** vs. Fine-Tuned Latency: **6.65 s**.
   - Baseline Throughput: **47.7 tok/s** vs. Fine-Tuned Throughput: **67.9 tok/s**.
