...
| **Avg Inference Latency** | **10111.6 ms** (10.11 s) | **6570.3 ms** (6.57 s) | -3541.3 ms (-35.0%) | 38.5% Latency Reduction |
| **Generation Throughput** | **47.7 tok/s** | **68.2 tok/s** | +20.5 tok/s | Higher Generation Speed |
...
| **CTX-01** | *"It's freezing and dark in here"* | **PASS** | **PASS** | `['thermostat.set_temperature', 'living_room_light.turn_on']` | `['living_room_light.turn_on', 'thermostat.set_temperature']` |
| **CTX-02** | *"I'm heading to sleep"* | **PASS** | **PASS** | `['living_room_light.turn_off', 'front_door_lock.lock']` | `['living_room_light.turn_off', 'kitchen_light.turn_off', 'bedroom_light.turn_off', 'entertainment_unit.turn_off', 'front_door_lock.lock']` |
...
| **CTX-04** | *"I am leaving the house"* | **PASS** | **PASS** | `['front_door_lock.lock']` | `['front_door_lock.lock', 'lock_pc.lock']` |
...
| **PC-04** | *"Lock my computer"* | **PASS** | **PASS** | `['lock_pc.lock']` | `['lock_pc.lock']` |
...
3. **Inference Latency & Generation Speed:**
   - Baseline Latency: **10.11 s** vs. Fine-Tuned Latency: **6.57 s**.
   - Baseline Throughput: **47.7 tok/s** vs. Fine-Tuned Throughput: **68.2 tok/s**.
