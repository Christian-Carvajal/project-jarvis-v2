...
| **Avg Inference Latency** | **10111.6 ms** (10.11 s) | **6469.2 ms** (6.47 s) | -3642.4 ms (-36.0%) | 38.5% Latency Reduction |
| **Generation Throughput** | **47.7 tok/s** | **67.8 tok/s** | +20.1 tok/s | Higher Generation Speed |
...
3. **Inference Latency & Generation Speed:**
   - Baseline Latency: **10.11 s** vs. Fine-Tuned Latency: **6.47 s**.
   - Baseline Throughput: **47.7 tok/s** vs. Fine-Tuned Throughput: **67.8 tok/s**.
