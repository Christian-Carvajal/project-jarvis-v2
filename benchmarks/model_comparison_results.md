...
| **Avg Inference Latency** | **10111.6 ms** (10.11 s) | **6635.6 ms** (6.64 s) | -3476.0 ms (-34.4%) | 38.5% Latency Reduction |
| **Generation Throughput** | **47.7 tok/s** | **67.4 tok/s** | +19.7 tok/s | Higher Generation Speed |
...
| **CTX-02** | *"I'm heading to sleep"* | **PASS** | **PASS** | `['living_room_light.turn_off', 'front_door_lock.lock']` | `['living_room_light.turn_off', 'kitchen_light.turn_off', 'bedroom_light.turn_off', 'front_door_lock.lock', 'entertainment_unit.turn_off']` |
| **CTX-03** | *"Movie night mode"* | **PASS** | **PASS** | `['living_room_light.turn_on', 'entertainment_unit.turn_on']` | `['living_room_light.turn_on', 'entertainment_unit.turn_on']` |
...
3. **Inference Latency & Generation Speed:**
   - Baseline Latency: **10.11 s** vs. Fine-Tuned Latency: **6.64 s**.
   - Baseline Throughput: **47.7 tok/s** vs. Fine-Tuned Throughput: **67.4 tok/s**.
